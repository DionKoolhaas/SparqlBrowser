var graph = {
  "nodes": [
    ...
    {"uri": "Is een Opleidingseenheid die door een Onderwijsaanbieder aangeboden wordt in het VO, in een bepaalde vorm, al dan niet op een bepaalde Onderwijslocatie.","bron":"http://lod.onderwijsregistratie.nl"}
  ],
  "links": [
